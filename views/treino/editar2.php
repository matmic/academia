		...
		'columns' => [
			...
			[
				'value' => function($model) {
					return Html::input('number', "Series[$model[IdAparelho]]", $model["Series"], ['min' => '0', 'onclick' => "$('#selection$model[IdAparelho]').prop('checked', true);"]);
				},
				'format' => 'raw',
				'label' => 'Séries',
			],
			[
				'value' => function($model) {
					return Html::input('number', "Repeticoes[$model[IdAparelho]]", $model["Repeticoes"], ['min' => '0']);
				},
				'format' => 'raw',
				'label' => 'Repetições',
			],
			[
				'value' => function($model) {
					return Html::input('number', "Peso[$model[IdAparelho]]", $model["Peso"], ['min' => '0']);
				},
				'format' => 'raw',
				'label' => 'Peso',
			],
